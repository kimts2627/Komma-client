    ...
    <div className="darkbackground">
      <section className="total-container">
        ...
        <p className="sign-desc">
          ⓒ Copyright 2021. deul-eo-jo Co. all rights reserved.
        </p>
        {isSignupModalOn ? (
          <Signup
          ...
          <article className="sign-container">
            ...
            <p className="sign-desc2">
              Don't have an account?
              <p onClick={handleSignupModal}>Create one</p>
            </p>
          </article>
        )}
      </section>
  ...
  return (
    <article className="sign-container">
      <img
        ...
        src={x}
        alt=""
        onClick={handleLoginModalForSignup}
      />
      ...
      <p className="sign-desc2">
        You have an account?<p onClick={handleSignupModal}>Sign In</p>
      </p>
    </article>
  );
};
