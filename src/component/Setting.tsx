        ...
        {isGeneralOption ? (
          <article className="setting-general">
            ...
            <div className="setting-general-colors">
              ...
              <div className="colors">
                ...
                />
                <div
                  className={color === "orange" ? "orange selected" : "orange"}
                  onClick={() => changeTheColor("orange")}
                />
                <div
                  className={color === "yellow" ? "yellow selected" : "yellow"}
                  onClick={() => changeTheColor("yellow")}
                />
                <div
                  className={color === "cyan" ? "cyan selected" : "cyan"}
                  onClick={() => changeTheColor("cyan")}
                />
                <div
                  className={color === "teal" ? "teal selected" : "teal"}
                  onClick={() => changeTheColor("teal")}
                />
                <div
                  className={color === "violet" ? "violet selected" : "violet"}
                  onClick={() => changeTheColor("violet")}
                />
                <div
                  className={color === "lime" ? "lime selected" : "lime"}
                  onClick={() => changeTheColor("lime")}
                />
                <div
                  className={color === "pink" ? "pink selected" : "pink"}
                  onClick={() => changeTheColor("pink")}
                />
                <div
                  className={color === "random" ? "random selected" : "random"}
                  onClick={() => changeTheColor("random")}
                />
              </div>
            </div>
          </article>
          ...
          <article className="setting-userinfo">
            ...
            {userInfoChangeMode ? (
              ...
              <button
                className="infobtn edit"
                onClick={handleUserInfoChangeMode}
              >
                Edit Userinfo
              </button>
            )}
            {userInfoChangeMode ? (
              <button
                className="infobtn back"
                onClick={handleUserInfoChangeMode}
              >
                Back
              </button>
            ) : (
              <button className="infobtn logout" onClick={logout}>
                Logout
              </button>
            )}
          </article>
