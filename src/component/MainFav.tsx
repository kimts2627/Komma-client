    ...
    <div>
      ...
      <nav className={width > 800 ? "fav-container" : "fav-container-m"}>
        <div className={width > 800 ? "fav-icons" : "fav-icons-m"}>
          <span className="fav-icons-desc">Mixtape ,</span>
        ...
        <Slider
          className={width > 800 ? "fav-cards" : "fav-cards-m"}
          {...settings}
        >
          {mixtapes?.map((tape) => (
            <SingleFav
...
export const SingleFav: React.FC<SingleFavProps> = ({
  ...
  const handlePlayMixtapes = () => {
    ...
    if (play) {
      width > 800
        ? (favRef.current.className = "fav-single")
        : (favRef.current.className = "fav-single-m");
  ...
  return (
    <div
      className={width > 800 ? "fav-single" : "fav-single-m"}
      ref={favRef}
      onClick={isDeleteMode && id < 900 ? deleteMixtape : handlePlayMixtapes}
    >
      {isDeleteMode && id < 900 ? (
        <img className="fav_delet_x" src={img_delete} alt="x" />
      ) : null}
      ...
      <div className="fav_modal">
        <div className="fav_iconbox">
          <img
            ...
            src={x}
            alt="x"
            onClick={onhandleListAddModal}
          />
          <img
            className="fav_icon"
            onClick={(e) => chooseIcon("https://i.imgur.com/vR7MiCh.png", e)}
            src={computer}
            alt="airpot"
            ref={iconRef1}
          />
          <img
            className="fav_icon"
            onClick={(e) => chooseIcon("https://i.imgur.com/E2u4I6X.png", e)}
            src={cycling}
            alt="airpot"
            ref={iconRef2}
          />
          <img
            className="fav_icon"
            onClick={(e) => chooseIcon("https://i.imgur.com/aiy6OCI.png", e)}
            src={heart}
            alt="airpot"
            ref={iconRef3}
          />
          <img
            className="fav_icon"
            onClick={(e) => chooseIcon("https://i.imgur.com/OJm8WyS.png", e)}
            src={question}
            alt="airpot"
            ref={iconRef4}
          />
          <img
            className="fav_icon"
            onClick={(e) => chooseIcon("https://i.imgur.com/TsyGxBq.png", e)}
            src={man}
            alt="airpot"
            ref={iconRef5}
          />
          <img
            className="fav_icon"
            onClick={(e) => chooseIcon("https://i.imgur.com/mc87bg6.png", e)}
            src={moon}
            alt="airpot"
            ref={iconRef6}
          />
          <img
            className="fav_icon"
            onClick={(e) => chooseIcon("https://i.imgur.com/nHbNWeR.png", e)}
            src={rating}
            alt="airpot"
            ref={iconRef7}
          />
          <img
            className="fav_icon"
            onClick={(e) => chooseIcon("https://i.imgur.com/POL0Oip.png", e)}
            src={shuffle}
            alt="airpot"
            ref={iconRef8}
          />
          <img
            className="fav_icon"
            onClick={(e) => chooseIcon("https://i.imgur.com/gi1x3TN.png", e)}
            src={smile1}
            alt="airpot"
            ref={iconRef9}
          />
          <img
            className="fav_icon"
            onClick={(e) => chooseIcon("https://i.imgur.com/rwGlahO.png", e)}
            src={smile}
            alt="airpot"
            ref={iconRef10}
          />
          <img
            className="fav_icon"
            onClick={(e) => chooseIcon("https://i.imgur.com/ZuC0S8E.png", e)}
            src={woman}
            alt="airpot"
            ref={iconRef11}
          />
          <img
            className="fav_icon"
            onClick={(e) => chooseIcon("https://i.imgur.com/Qo2Pa0H.png", e)}
            src={yoga}
            alt="airpot"
            ref={iconRef12}
          />
        ...
        />
        <button className="fav_button" onClick={saveMixtapes}>
          SAVE
        </button>
